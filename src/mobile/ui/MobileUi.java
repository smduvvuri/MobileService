...
import mobile.dao.MobileDaoImpl;
import mobile.entities.Mobile;
import mobile.service.IMobileService;
import mobile.service.MobileServiceImpl;
...
public class MobileUi {
    ...
    public void runUi() {
        try {
            ...
            switch(choice)
            {
            case 1:   Mobile w1 = new Mobile("9491651719","Ram", 700);
                          Mobile  w2=new Mobile("6755675542","Sam",100);
